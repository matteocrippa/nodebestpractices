...
<div align="center">
  <img src="https://img.shields.io/badge/⚙%20Contenuti%20-%2079%20Best%20practices-blue.svg" alt="79 contenuti"> <img src="https://img.shields.io/badge/%F0%9F%93%85%20Ultimo%20aggiornamento%20-%2015%20Dicembre%202018-green.svg" alt="Ultimo Aggiornamento: 15 Dicembre, 2018"> <img src="https://img.shields.io/badge/%E2%9C%94%20Aggioranto%20per%20Node%2010.13.0%20LTS-brightgreen.svg" alt="Aggiornato per Node 10.14.2 LTS">
</div>
...
Leggi in altre lingue: [![CN](/assets/flags/CN.png)**CN**](/README.chinese.md) [(![BR](/assets/flags/BR.png)**BR**, ![ES](/assets/flags/ES.png)**ES**, ![FR](/assets/flags/FR.png)**FR**, ![HE](/assets/flags/HE.png)**HE**, ![KR](/assets/flags/KR.png)**KR**, ![RU](/assets/flags/RU.png)**RU** e ![TR](/assets/flags/TR.png)**TR** in corso!)](#translations)

<br/>

# Benvenuto/a! 3 Cose che devi sapere subito:

**1. Quando ci leggerai, starai leggendo una raccolta di svariati fra i migliori contenuti riguardo Node.sj -** questo è un riassunto curato delle migliori pratiche per Node.js

**2. È una raccolta molto vasta, che cresce ogni settimana -** attualmente ci sono più di 50 fra migliori pratiche, linee guida di stile, e consigli per le tipologie di archiettura.
Nuove issue e PR sono create ogni gorno per tenere freschi i contenuti. Ma ci piacerebbe vedere anche il tuo contributo qui, sia per sistemare qualche errore o suggerire delle migliorie. Qui trovi il nostro piano e [milestones](https://github.com/i0natan/nodebestpractices/milestones?direction=asc&sort=due_date&state=open)

**3. Molte voci hanno ulteriori informazioni -** vicino ad ogni suggerimento puoi torvare un link **🔗Scopri di più**, all'interno troverai alcuni esempi o citazioni da blog o altri dettagli ancora.
...
**TL;DR:** The worst large applications pitfall is maintaining a huge code base with hundreds of dependencies - such a monolith slows down developers as they try to incorporate new features. Instead, partition your code into components, each gets its own folder or a dedicated codebase, and ensure that each unit is kept small and simple. Visit 'Scopri di più' below to see examples of correct project structure
...
🔗 [**Scopri di più: structure by components**](/sections/projectstructre/breakintcomponents.md)
...
🔗 [**Scopri di più: layer your app**](/sections/projectstructre/createlayers.md)
...
🔗 [**Scopri di più: Structure by feature**](/sections/projectstructre/wraputilities.md)
...
🔗 [**Scopri di più: separate Express 'app' and 'server'**](/sections/projectstructre/separateexpress.md)
...
🔗 [**Scopri di più: configuration best practices**](/sections/projectstructre/configguide.md)
...
🔗 [**Scopri di più: avoiding callbacks**](/sections/errorhandling/asyncerrorhandling.md)
...
🔗 [**Scopri di più: using the built-in error object**](/sections/errorhandling/useonlythebuiltinerror.md)
...
🔗 [**Scopri di più: operational vs programmer error**](/sections/errorhandling/operationalvsprogrammererror.md)
...
🔗 [**Scopri di più: handling errors in a centralized place**](/sections/errorhandling/centralizedhandling.md)
...
🔗 [**Scopri di più: documenting errors in Swagger**](/sections/errorhandling/documentingusingswagger.md)
...
🔗 [**Scopri di più: shutting the process**](/sections/errorhandling/shuttingtheprocess.md)
...
🔗 [**Scopri di più: using a mature logger**](/sections/errorhandling/usematurelogger.md)
...
🔗 [**Scopri di più: testing error flows**](/sections/errorhandling/testingerrorflows.md)
...
🔗 [**Scopri di più: using APM products**](/sections/errorhandling/apmproducts.md)
...
🔗 [**Scopri di più: catching unhandled promise rejection**](/sections/errorhandling/catchunhandledpromiserejection.md)
...
🔗 [**Scopri di più: failing fast**](/sections/errorhandling/failfast.md)
...
🔗 [**Scopri di più:** "Why does a results vary based on curly brace placement?" (Stackoverflow)](https://stackoverflow.com/questions/3641519/why-does-a-results-vary-based-on-curly-brace-placement)
...
🔗 [**Scopri di più: JavaScript ES6+: var, let, or const?** ](https://medium.com/javascript-scene/javascript-es6-var-let-or-const-ba58b8dcde75)
...
🔗[**Scopri di più:** Guide to async await 1.0](https://github.com/yortus/asyncawait)
...
🔗 [**Scopri di più: Choosing CI platform**](/sections/testingandquality/citools.md)
...
🔗 [**Scopri di più: Refactoring!**](/sections/testingandquality/refactoring.md)
...
🔗 [**Scopri di più: Monitoring!**](/sections/production/monitoring.md)
...
🔗 [**Scopri di più: Increase transparency using smart logging**](/sections/production/smartlogging.md)
...
🔗 [**Scopri di più: Delegate anything possible (e.g. gzip, SSL) to a reverse proxy**](/sections/production/delegatetoproxy.md)
...
🔗 [**Scopri di più: Lock dependencies**](/sections/production/lockdependencies.md)
...
🔗 [**Scopri di più: Guard process uptime using the right tool**](/sections/production/guardprocess.md)
...
🔗 [**Scopri di più: Utilize all CPU cores**](/sections/production/utilizecpu.md)
...
🔗 [**Scopri di più: Create a ‘maintenance endpoint’**](/sections/production/createmaintenanceendpoint.md)
...
🔗 [**Scopri di più: Discover errors and downtime using APM products**](/sections/production/apmproducts.md)
...
🔗 [**Scopri di più: Make your code production-ready**](/sections/production/productoncode.md)
...
🔗 [**Scopri di più: Measure and guard the memory usage**](/sections/production/measurememory.md)
...
🔗 [**Scopri di più: Get your frontend assets out of Node**](/sections/production/frontendout.md)
...
🔗 [**Scopri di più: Be stateless, kill your Servers almost every day**](/sections/production/bestateless.md)
...
🔗 [**Scopri di più: Use tools that automatically detect vulnerabilities**](/sections/production/detectvulnerabilities.md)
...
🔗 [**Scopri di più: Assign ‘TransactionId’ to each log statement**](/sections/production/assigntransactionid.md)
...
🔗 [**Scopri di più: Set NODE_ENV=production**](/sections/production/setnodeenv.md)
...
🔗 [**Scopri di più: Use an LTS release of Node.js**](/sections/production/LTSrelease.md)
...
🔗 [**Scopri di più: Log Routing**](/sections/production/logrouting.md)
...
**TL;DR:** Make use of security-related linter plugins such as [eslint-plugin-security](https://github.com/nodesecurity/eslint-plugin-security) to catch security vulnerabilities and issues as early as possible , at best  while they're being coded. This can help catching security weaknesses like using eval, invoking a child process or importing a module with a string literal (e.g. user input). Click 'Scopri di più' below to see code examples that will get caught by a security linter

**Otherwise:** What could have been a straightforward security weakness during development becomes a major issue in production. Also, the project may not follow consistent code security practices, leading to vulnerabilities being introduced, or sensitive secrets committed into remote repositories

🔗 [**Scopri di più: Lint rules**](/sections/security/lintrules.md)
...
🔗 [**Scopri di più: Implement rate limiting**](/sections/security/limitrequests.md)
...
🔗 [**Scopri di più: Secret management**](/sections/security/secretmanagement.md)
...
🔗 [**Scopri di più: Query injection prevention using ORM/ODM libraries**](/sections/security/ormodmusage.md)

<br/><br/>

## ![✔] 6.5. Collection of generic security best practices

**TL;DR:** This is a collection of security advice that are not related directly to Node.js - the Node implementation is not much different than any other language. Click Scopri di più to skim through.

🔗 [**Scopri di più: Common security best practices**](/sections/security/commonsecuritybestpractices.md)
...
🔗 [**Scopri di più: Using secure headers in your application**](/sections/security/secureheaders.md)
...
🔗 [**Scopri di più: Dependency security**](/sections/security/dependencysecurity.md)
...
🔗 [**Scopri di più: Use Bcrypt**](/sections/security/bcryptpasswords.md)
...
🔗 [**Scopri di più: Escape output**](/sections/security/escape-output.md)
...
🔗 [**Scopri di più: Validate incoming JSON schemas**](/sections/security/validation.md)
...
🔗 [**Scopri di più: Blacklist JSON Web Tokens**](/sections/security/expirejwt.md)
...
🔗 [**Scopri di più: Login rate limiting**](/sections/security/login-rate-limit.md)
...
🔗 [**Scopri di più: Run Node.js as non-root user**](/sections/security/non-root-user.md)
...
🔗 [**Scopri di più: Limit payload size**](/sections/security/requestpayloadsizelimit.md)
...
🔗 [**Scopri di più: Avoid JavaScript eval statements**](/sections/security/avoideval.md)
...
🔗 [**Scopri di più: Prevent malicious RegEx**](/sections/security/regex.md)
...
🔗 [**Scopri di più: Safe module loading**](/sections/security/safemoduleloading.md)
...
🔗 [**Scopri di più: Run unsafe code in a sandbox**](/sections/security/sandbox.md)
...
🔗 [**Scopri di più: Be cautious when working with child processes**](/sections/security/childprocesses.md)
...
🔗 [**Scopri di più: Hide error details from client**](/sections/security/hideerrors.md)
...
🔗 [**Scopri di più: Cookie and session security**](/sections/security/sessions.md)
...
🔗 [**Scopri di più: Prevent unsafe redirects**](/sections/security/saferedirects.md)
...
Tutte le traduzioni sono sontributi della community. Saremo felici di ricevere supporto per quelle da creare, in fase di traduzione e completate!

### Traduzioni completate

- ![CN](/assets/flags/CN.png) [Cinese](README.chinese.md) - Per cortesia di [Matt Jin](https://github.com/mattjin)
...
- ![KR](/assets/flags/KR.png) [Coreano](README.korean.md) - Per cortesia di [Sangbeom Han](https://github.com/uronly14me) ([Discussione](https://github.com/i0natan/nodebestpractices/issues/94))
...
Consulente Node.js indipendente che lavora con clienti in USA, Europa e Israele.
Si occupa di sviluppo di soluzioni scalabili su larga scala.
Molte linee guida sono apparse per la prima volta sul suo blog [goldbergyoni.com](https://goldbergyoni.com). Contatta Yoni via @goldbergyoni o me@goldbergyoni.com
...
Questo repository è tenuto aggiornato grazie all'aiuto della community. Apprezziamo ogni contributo, dalla singola parola corretta al suggerimento di una nuova linea guida. Sotto trovate la lista delle persone che hanno contribuito al progetto. Il 🌻 significa che una pull request è stata accettata, mentre una ⭐ segnala l'approvazione di una nuova pratica.
